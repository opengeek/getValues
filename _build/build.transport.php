...
//$builder->registerNamespace('getvalues',false,true,'{core_path}components/getvalues/');

/* create snippet object */
$modx->log(xPDO::LOG_LEVEL_INFO,'Adding in snippet.'); flush();
$snippet= $modx->newObject('modSnippet');
$snippet->set('name', 'getValues');
$snippet->set('description', '<strong>'.PKG_VERSION.'-'.PKG_RELEASE.'</strong> Get values from a single field in a collection of xPDOObjects');
$snippet->set('category', 0);
$snippet->set('snippet', file_get_contents($sources['root'] . 'getValues.snippet.php'));
